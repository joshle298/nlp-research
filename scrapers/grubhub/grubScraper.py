...
def get_item(browser, id):
    ...
    _options = {}
    options = html.find_all(
        "div", class_="menuItemModal-options"
...
def get_menu(url):
    ...
    cat_items = [
        [itm.text for itm in cat.find_all("a", class_="menuItem-name")] for cat in cats
    ]
    prices = [
        [p.text for p in cat.find_all("span", class_="menuItem-displayPrice")]
        for cat in cats
    ]
...
get_menu("https://grubhub.com/restaurant/insomnia-cookies-76-pearl-st-new-york/295836")
